function [spindle_det, filtTraces] = detect_spindles(Data, ch_names, fs, bpparms, doWavelet, ampl_factor, minmaxdurs, sigproc)
%%
...
% =========================
% ------------------
% Time that signal has to exceed background noise level
% tthresh = 0.4; %in seconds; default is 400ms
% threshold_type     = 'median';
% 
% % Factor to multiply the mean of the signal in the spindle detection
% ampl_factor        = 9.0; % default is 4.5
% 
% % Spindle duration constraints
% minmaxdurs         = [400 3000];
% 
% % Spindle charazcterization constraints (does NOT apply to filtering or detection!!!!)
% spindle_lower_stop = 8;
% spindle_lower_freq = 10;%10;
% spindle_upper_freq = 16;
% spindle_upper_stop = 18;
% bpparams           = [spindle_lower_freq,...
%                       spindle_upper_freq,...
%                       spindle_lower_stop,...
%                       spindle_upper_stop ];
% 
% %                
% % ------------------
% [allSpindlesHilbert,filtTracesSpindles] = detect_spindles( n2eeg',...
%                                                                 eeg_chnames,...
%                                                                 fs,...
%                                                                 bpparams,...
%                                                                 true,...
...
%                                                                 'filter-hilbert');
% % =========================
% % for ix = 1:size(allSpindlesHilbert,2), allSpindlesHilbert(ix).datalen = size(n2eeg,1); end
% 
% % ------------------
% [allSpindlesWavelet,~] = detect_spindles( n2eeg',...
%                                                                 eeg_chnames,...
%                                                                 fs,...
%                                                                 bpparams,...
%                                                                 true,...
